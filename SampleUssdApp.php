<?php
/**
 * PHP USSD Quickstart guide - Ideamart Developer Bundle
 */
...
include_once 'lib/MoUssdReceiver.php';
include_once 'lib/MtUssdSender.php';
include_once 'log.php';


$receiver = new MoUssdReceiver(); // Create the Receiver object from
...
if (($receiver->getUssdOperation()) == "mo-init") { //Send the main menu
    ...
    // $val = $db-> UseraddressCheck($address);

    // if(1==1){
        //$subc->NewUser(APP_ID,APP_PASSWORD,$address);
        loadUssdSender($sessionId,
                  $responseMsg["main"], $address);
    // }


    // else{
    // loadUssdSender($sessionId, "ABC", $address);}
